    ...
    <div class="row mb-3 text-center border border-2 rounded">
        ...
        <div class="col-md-6 themed-grid-col">
            <div class="row">
                ...
                <div class="p-1 col-md-6 themed-grid-col">
                    <a href="#" class="card-link btn btn-primary visualizar-pdf" data-toggle="modal" data-target="#myModal" data-id="{{ $venda->id }}" data-nome="{{ $venda->user->name }}" data-cpf="{{ $venda->user->cpf }}" data-logradouro="{{ $venda->user->logradouro }}" data-numero-casa="{{ $venda->user->numero_casa }}" data-bairro="{{ $venda->user->bairro }}" data-cidade="{{ $venda->user->cidade }}" data-estado="{{ $venda->user->estado }}" data-email="{{ $venda->user->email }}" data-nome-pacote="{{ $venda->nomePacote }}" data-quantidade-placas="{{ $venda->quantidadePlacas }}" data-valor-final="{{ number_format($venda->valorFinal, 2, ',', '.') }}" data-compra-data="{{ $venda->created_at }}">
                        Visualizar PDF
                    </a>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 body-main">
                            <div class="col-md-12">
                                ...
                                <div>
                                    <div class="col-md-12">
                                        <p><b>Data da Compra :</b> {{ date('d/m/Y', strtotime($venda->created_at)) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
