            ...
            <div class="row mb-3 text-center border border-2 rounded">
                ...
                <div class="col-md-6 themed-grid-col">
                    <div class="row">
                        ...
                        <div class="p-1 col-md-6 themed-grid-col">
                            <a href="#" class="card-link btn btn-primary" data-toggle="modal" data-target="#myModal"
                                data-id="{{ $venda->id }}">
                                Visualizar PDF
                            </a>
                        </div>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 text-right">
                                            ...
                                            <p>{{ $venda->user->bairro }},
                                                {{ $venda->user->cidade }}/{{ $venda->user->estado }}</p>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-3">R$
                                                        {{ number_format($venda->valorFinal, 2, ',', '.') }} </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right">
                                                        <p>
                ...
                <a href="{{ route('gerarPDF', ['id' => $venda->id]) }}" class="card-link btn btn-primary">Gerar PDF</a>
            </div>
        </div>
    </div>
    </div>
