...
<body>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3 body-main">
                    <div class="col-md-12">
                       <div class="row">
                            <div class="col-md-4">
                                <img class="img" alt="Logo" src={{ asset('images/logoProjetoSolarTech.png')}} />
                            </div>
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                    ...
                                    <tr style="color: #272727;">
                                        ...
                                        <td class="text-left"><h4><strong><i class="fas fa-rupee-sign" area-hidden="true"></i> R$ {{ number_format($invoice->valorFinal, 2, ',', '.') }}</strong></h4></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js"
        integrity="sha384-oBqDVmMz9ATKxIep9tiCxS/Z9fNfEX/ndQFK4d5dI6FfO1qQ5gRVVEhfbI" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.min.js"
        integrity="sha384-eU7ucRRXC6viV6i3Uqwe5Qb3a6P/6ucSMFkYfG/kb9pG0ehG6L8kceZ5nAiN" crossorigin="anonymous"></script>
</body>
